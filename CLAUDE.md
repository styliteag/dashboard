...
pf1=10.20.1.200 (pfSense CE 2.8.1), pf2=10.20.1.217 (pfSense CE 2.7.2, deliberately
old for series-upgrade testing; ports unconfirmed); ssh port 9922 (root shell is
tcsh); GUI/API on :4444. Shared with other developers — record what you verified in
the commit body.
