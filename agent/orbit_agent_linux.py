...
# >>> shared:run-helper — generated from agent/src/shared/run-helper.py; edit there, run `just build-agent`
...
# (no drop-in parts in agent/src/linux.d/)
_SNAPSHOT_SECTIONS = (
...
# >>> shared:ws-client — generated from agent/src/shared/ws-client.py; edit there, run `just build-agent`
# to orbit_agent.py AND orbit_agent_linux.py — test_agent_split enforces
# byte equality of this block.
...
# >>> shared:self-update — generated from agent/src/shared/self-update.py; edit there, run `just build-agent`
# to orbit_agent.py AND orbit_agent_linux.py — test_agent_split enforces
# byte equality of this block.
def _self_path() -> str:
...
# >>> shared:probation — generated from agent/src/shared/probation.py; edit there, run `just build-agent`
# to orbit_agent.py AND orbit_agent_linux.py — test_agent_split enforces
# byte equality of this block.
...
# >>> shared:push-loop — generated from agent/src/shared/push-loop.py; edit there, run `just build-agent`
# to orbit_agent.py AND orbit_agent_linux.py — test_agent_split enforces
# byte equality of this block.
...
# >>> shared:shell-capture — generated from agent/src/shared/shell-capture.py; edit there, run `just build-agent`
# to orbit_agent.py AND orbit_agent_linux.py — test_agent_split enforces
# byte equality of this block.
...
# >>> shared:enrollment — generated from agent/src/shared/enrollment.py; edit there, run `just build-agent`
# to orbit_agent.py AND orbit_agent_linux.py — test_agent_split enforces
# byte equality of this block.
